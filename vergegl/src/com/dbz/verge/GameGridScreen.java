...
public class GameGridScreen extends GLScreen {
    ...
    public GameGridScreen(Game game) {
        ...
        firstMicroGameBounds = new Rectangle(315, 430, 170, 170);
        secondMicroGameBounds = new Rectangle(555, 430, 170, 170);
        thirdMicroGameBounds = new Rectangle(795, 430, 170, 170);
        fourthMicroGameBounds = new Rectangle(315, 195, 170, 170);
        fifthMicroGameBounds = new Rectangle(555, 195, 170, 170);
        sixthMicroGameBounds = new Rectangle(795, 195, 170, 170);          
    }       
    ...
    public void present(float deltaTime) {
        ...
        batcher.drawSprite(315, 430, 170, 170, Assets.boundOverlayRegion); // 1st MicroGame Bounding Box
        batcher.drawSprite(555, 430, 170, 170, Assets.boundOverlayRegion); // 2nd MicroGame Bounding Box
        batcher.drawSprite(795, 430, 170, 170, Assets.boundOverlayRegion); // 3rd MicroGame Bounding Box
        batcher.drawSprite(315, 195, 170, 170, Assets.boundOverlayRegion); // 4th MicroGame Bounding Box
        batcher.drawSprite(555, 195, 170, 170, Assets.boundOverlayRegion); // 5th MicroGame Bounding Box
        batcher.drawSprite(795, 195, 170, 170, Assets.boundOverlayRegion); // 6th MicroGame Bounding Box
